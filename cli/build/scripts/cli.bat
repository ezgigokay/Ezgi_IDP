...
set CLASSPATH=%APP_HOME%\lib\cli.jar;%APP_HOME%\lib\kotlin-stdlib-2.0.21.jar;%APP_HOME%\lib\annotations-13.0.jar


@rem Execute cli
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLI_OPTS%  -classpath "%CLASSPATH%" com.example.consoleapp.TaskManagerMainKt %*
